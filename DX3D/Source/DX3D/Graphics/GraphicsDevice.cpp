...
GraphicsPipelineStatesPtr dx3d::GraphicsDevice::createGraphicsPipelineStates(const GraphicsPipelineStatesDesc& desc)
{
	return std::make_shared<GraphicsPipelineStates>(desc , getGraphicsResourceDesc());
}
